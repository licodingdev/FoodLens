...
<head>
    ...
    <title>Kayıt Ol - FoodLens AI</title>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-500 mt-2">Hesabınızı oluşturun</p>
                </div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="login.php" class="text-gray-800 hover:text-gray-900 font-medium">
                            Giriş yapın
                        </a>
                    </p>
                </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-xs text-gray-500">
                        Kayıt olarak 
                        <a href="#" class="text-gray-800 hover:text-gray-900">kullanım şartlarını</a> ve 
                        <a href="#" class="text-gray-800 hover:text-gray-900">gizlilik politikasını</a> 
